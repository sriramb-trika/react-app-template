...
const MegamenuMobile: StorefrontFunctionComponent = ({megaMenu}: {megaMenu: MegaMenuItem[]}) => {
          ...
          {filteredMenu.map((menuItem: MegaMenuItem) => (
            <div className={`firstLevel`}>
              ...
              >
                ...
                <div className={`subLevels secondLeve ${
                              ...
                              (subItems: MegaMenuItem) => (
                                <div>
                                  <div
                                    ...
                                    onClick={() => {
                                      toggleMenu.menuItem2 !==
                                      subItems.__editorItemTitle
                                        ? setToggleMenu((prevState) => ({
                                            ...prevState,
                                            menuItem2:
                                              subItems.__editorItemTitle,
                                  ...
                                  >
                                    <MenuListMobile
                                      ...
                                      toggleMenu={toggleMenu.menuItem2} hasChildren={false}                                    />
                                  </div>
                                  <div
